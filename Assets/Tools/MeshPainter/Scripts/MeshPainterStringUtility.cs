...
public class MeshPainterStringUtility
{
    ...
    public static string meshPaintEditorFolder = "Assets/Tools/MeshPainter/Editor/";
    public static string contolTexFolder = "Assets/Tools/MeshPainter/Controler/";
    ...
    //shader中使用的贴图
    public static string tex_1 = "_Layer1";
    public static string tex_2 = "_Layer2";
    public static string tex_3 = "_Layer3";
    public static string tex_4 = "_Layer4";
    /// <summary>
    /// 射线检测层级
    /// </summary>
    ...
    /// 区域控制图名字
    /// </summary>
    public static string shaderControlTexName = "_BlendMap";
