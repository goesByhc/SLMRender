...
namespace UI.ThreeDimensional
{
    ...
    {
        [Header("灯光旋转"), SerializeField]
        private Vector3 _LightRotation = new Vector3(0, 0, -2.5f);
        ...
        [Header("光照强度"),SerializeField, Range(0, 8)]
        ...
        void SpawnLight()
        {
            ...
            _lightObject.type = LightType.Directional;
            _lightObject.bounceIntensity = 0;
        }

        void SetLightPosition(bool scheduleRender = true)
        {
            lightObject.transform.localRotation = UnityEngine.Quaternion.Euler(LightRotation);
