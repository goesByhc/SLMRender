...
namespace UI.ThreeDimensional
{
    ...
    public class UIObject3D : MonoBehaviour
    {
        ...
        [Header("人物X偏移"), SerializeField, Range(-10, 10)]
        private float _TargetOffsetX = 0f;
        [Header("人物Y偏移"), SerializeField, Range(-10, 10)]
        ...
        [Header("摄像机 视口大小"), SerializeField, Range(20, 100)]
        ...
        [Header("摄像机距离"), SerializeField, Range(-10, -1)]
        ...
        void Prepare()
        {
            ...
            SetupTargetCamera();
            if (imageComponent.texture == null && _targetCamera != null)
            {
                imageComponent.texture = _targetCamera.targetTexture;
            }
        }
        ...
        internal void Render(bool instant = false)
        {
            ...
            {
                _imageComponent.texture = renderTexture;
        ...
        private void UpdateTargetPositioningAndScale()
        {
            ...
            if (renderer != null)
            {
                if (initial)
                {
                    ...
                    _target.transform.localPosition -= new Vector3(0, targetBounds.center.y, 0);
                }
