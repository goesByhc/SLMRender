...
namespace Animancer
{
        ...
        IAnimancerComponent, IEnumerator, IAnimationClipSource, IAnimationClipCollection
    {
        ...
        public void SetActionOnDisable(DisableAction actionOnDisable)
        {
            ActionOnDisable = actionOnDisable;
        }
        
        public void SetActionOnDisable(int actionOnDisable)
        {
            SetActionOnDisable((DisableAction)actionOnDisable);
        }
