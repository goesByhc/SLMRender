...
Shader "MobileSSPR/ExampleShader"
{
    Properties
    {
        ...
        [MainTexture] _MainTex("BaseMap", 2D) = "black" {}
...
//            			Tags { "LightMode"="UniversalForward" }
            ...
            Varyings vert(Attributes IN)
            {
                ...
                OUT.uv = TRANSFORM_TEX(IN.uv, _MainTex) + _Time.y*_UV_MoveSpeed;
            ...
            { 
                //base color
                half3 baseColor = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, IN.uv) * _BaseColor.rgb;
