Shader "Terrain_Blinn_2"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half Blend(half4 blendFactor, half p1, half p2)
            {
                ...
                return channalA * p1 + channalB * p2;
            }

            half4 Blend(half4 blendFactor, half4 p1, half4 p2)
            {
            ...
            half4 frag (VertexOutputObjectBlinn i) : SV_Target
            {
                ...
                //Blend
                half3 baseColor = Blend(blendMap, layer1, layer2).rgb;
                half4 _Color = Blend(blendMap, _Layer1_Color, _Layer2_Color);
                half _Brightness = Blend(blendMap, _Layer1_Brightness, _Layer2_Brightness);
                half _Saturation = Blend(blendMap, _Layer1_Saturation, _Layer2_Saturation);
                half4 _SpecColor = Blend(blendMap, _Layer1_SpecColor, _Layer2_SpecColor);
                half _Roughness = Blend(blendMap, _Layer1_Roughness, _Layer2_Roughness);
                half _SpecIntensity = Blend(blendMap, _Layer1_SpecIntensity, _Layer2_SpecIntensity);
                half4 _RimColor = Blend(blendMap, _Layer1_RimColor, _Layer2_RimColor);
                half4 _RimPower = Blend(blendMap, _Layer1_RimPower, _Layer2_RimPower);
                half4 _RimIntensity = Blend(blendMap, _Layer1_RimIntensity, _Layer2_RimIntensity);
