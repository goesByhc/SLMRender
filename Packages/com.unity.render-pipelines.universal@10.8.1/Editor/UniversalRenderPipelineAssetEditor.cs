...
namespace UnityEditor.Rendering.Universal
{
    ...
    [MovedFrom("UnityEditor.Rendering.LWRP")] public class UniversalRenderPipelineAssetEditor : Editor
    {
        internal class Styles
        {
            ...
            // public static GUIContent shadowNoiseTex = EditorGUIUtility.ObjectContent("PCF Filter Radius", T));

            public static GUIContent shadowPCFFilterRadius = EditorGUIUtility.TrTextContent("PCF Filter Radius", "模糊半径");
            public static GUIContent shadowPCSSSearchRadius = EditorGUIUtility.TrTextContent("PCS Search Radius", "灯光半影区半径");
        ...
        SerializedProperty m_ShadowNoiseTex;
        SerializedProperty m_ShadowPCFFilterRadius;
        SerializedProperty m_ShadowPCSSSearchRadius;
        ...
        void OnEnable()
        {
            ...
            m_ShadowNoiseTex = serializedObject.FindProperty("m_ShadowNoiseTex");
            m_ShadowPCFFilterRadius = serializedObject.FindProperty("m_PCSFilterRadius");
            m_ShadowPCSSSearchRadius = serializedObject.FindProperty("m_PCSSSearchRadius");
        ...
        void DrawShadowSettings()
        {
            ...
            if (m_ShadowSettingsFoldout.value)
            {
                ...
                m_ShadowNoiseTex.objectReferenceValue = EditorGUILayout.ObjectField("ShadowNoiseTex", m_ShadowNoiseTex.objectReferenceValue, typeof(Texture), true);

                // (target as UniversalRenderPipelineAsset).shadowNoiseTex = m_ShadowNoiseTex;m_ShadowNoiseTex
                
                m_ShadowPCFFilterRadius.floatValue = EditorGUILayout.Slider(Styles.shadowPCFFilterRadius, m_ShadowPCFFilterRadius.floatValue, 0.0f, UniversalRenderPipeline.maxPCSFilterRadius);
                m_ShadowPCSSSearchRadius.floatValue = EditorGUILayout.Slider(Styles.shadowPCSSSearchRadius, m_ShadowPCSSSearchRadius.floatValue, 0.0f, UniversalRenderPipeline.maxPCSFilterRadius);
