...
namespace UnityEngine.Rendering.Universal
{
    ...
    public partial class UniversalRenderPipelineAsset : RenderPipelineAsset, ISerializationCallbackReceiver
    {
        ...
        [SerializeField] Texture m_ShadowNoiseTex = null;
        [SerializeField] float m_PCSFilterRadius = 1.0f;
        [SerializeField] float m_PCSSSearchRadius = 1.0f;
        ...
        /// PCS阴影模糊半径
        /// </summary>
        public Texture shadowNoiseTex
        {
            get { return m_ShadowNoiseTex; }
            set { m_ShadowNoiseTex = value; }
        }
        
        /// <summary>
        /// PCS阴影模糊半径
        /// </summary>
        public float shadowPCSFilterRadius
        {
            get { return m_PCSFilterRadius; }
            set { m_PCSFilterRadius = ValidatePCSFilterRadius(value); }
        }

        /// <summary>
        /// PCSS阴影灯光大小
        /// </summary>
        public float shadowPCSSSearchRadius
        {
            get { return m_PCSSSearchRadius; }
            set { m_PCSSSearchRadius = ValidatePCSSSearchRadius(value); }
        }
...
#pragma warning restore 618 // Obsolete warning
        ...
        float ValidatePCSFilterRadius(float value)
        {
            return Mathf.Max(0.0f, Mathf.Min(value, UniversalRenderPipeline.maxPCSFilterRadius));
        }
        
        float ValidatePCSSSearchRadius(float value)
        {
            return Mathf.Max(0.0f, Mathf.Min(value, UniversalRenderPipeline.maxPCSSSearchRadius));
        }
