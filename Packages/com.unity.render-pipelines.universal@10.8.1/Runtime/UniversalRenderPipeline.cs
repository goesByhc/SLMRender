...
namespace UnityEngine.Rendering.Universal
{
    public sealed partial class UniversalRenderPipeline : RenderPipeline
    {
        ...
        public static float maxPCSFilterRadius
        {
            get => 20.0f;
        }
        
        public static float maxPCSSSearchRadius
        {
            get => 20.0f;
        }
...
#pragma warning restore 0618
        ...
        static void InitializeShadowData(UniversalRenderPipelineAsset settings, NativeArray<VisibleLight> visibleLights, bool mainLightCastShadows, bool additionalLightsCastShadows, out ShadowData shadowData)
        {
            ...
            shadowData.pcsFilterRadius = settings.shadowPCSFilterRadius;
            shadowData.pcssSearchRadius = settings.shadowPCSSSearchRadius;
            shadowData.shadowNoiseTex = settings.shadowNoiseTex;
        }
