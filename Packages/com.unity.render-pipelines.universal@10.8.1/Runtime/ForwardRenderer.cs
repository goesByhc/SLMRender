...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed class ForwardRenderer : ScriptableRenderer
    {
        ...
        // DrawBloomPrePass m_DrawBloomPrePass;
...
#pragma warning restore 414
        ...
        public ForwardRenderer(ForwardRendererData data) : base(data)
        {
           ...
           // m_RenderOpaqueOutlinePass = new DrawObjectsPass("Render Opaques Outline", new ShaderTagId[] {new ShaderTagId("Outline")}, true, RenderPassEvent.BeforeRenderingOpaques + 1, RenderQueueRange.opaque, data.opaqueLayerMask, m_DefaultStencilState, stencilData.stencilReference);
            ...
            // m_DrawBloomPrePass = new DrawBloomPrePass(URPProfileId.DrawTransparentObjects, false, RenderPassEvent.BeforeRenderingTransparents, RenderQueueRange.transparent, data.transparentLayerMask, m_DefaultStencilState, stencilData.stencilReference);
        ...
        public override void Setup(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            //Custom Start
          // EnqueuePass(m_RenderOpaqueOutlinePass);
            //Custom End
            ...
            //Custom Start
            // EnqueuePass(m_DrawBloomPrePass);
            //Custom End
        ...
        void CreateCameraRenderTarget(ScriptableRenderContext context, ref RenderTextureDescriptor descriptor, bool createColor, bool createDepth)
        {
            ...
            using (new ProfilingScope(cmd, Profiling.createCameraRenderTarget))
            {
                if (createColor)
                {
                    ...
                    // colorDescriptor.graphicsFormat = GraphicsFormat.A2R10G10B10_UNormPack32;
                    // colorDescriptor.graphicsFormat = GraphicsFormat.bgra

                    colorDescriptor.graphicsFormat = GraphicsFormat.R8G8B8A8_SRGB;
#if UNITY_EDITOR
                    if (EditorUserBuildSettings.activeBuildTarget == BuildTarget.StandaloneWindows)
                    {
                        colorDescriptor.graphicsFormat = GraphicsFormat.R16G16B16A16_UNorm;
                    }
#endif
