...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class MainLightShadowCasterPass : ScriptableRenderPass
    {
        private static class MainLightShadowConstantBuffer
        {
            ...
            public static int _ShadowNoiseTex;
            public static int _ShadowNoiseTexResolution;
            public static int _ShadowPCSFilterRadius;
            public static int _ShadowPCSSSearchRadius;
        }
        ...
        public MainLightShadowCasterPass(RenderPassEvent evt)
        {
            ...
            MainLightShadowConstantBuffer._ShadowNoiseTex = Shader.PropertyToID("_ShadowNoiseTex");
            MainLightShadowConstantBuffer._ShadowNoiseTexResolution = Shader.PropertyToID("_ShadowNoiseTexResolution");
            MainLightShadowConstantBuffer._ShadowPCSFilterRadius = Shader.PropertyToID("_PCSFilterRadius");
            MainLightShadowConstantBuffer._ShadowPCSSSearchRadius = Shader.PropertyToID("_PCSSSearchRadius");
        ...
        void RenderMainLightCascadeShadowmap(ref ScriptableRenderContext context, ref CullingResults cullResults, ref LightData lightData, ref ShadowData shadowData)
        {
            ...
            using (new ProfilingScope(cmd, ProfilingSampler.Get(URPProfileId.MainLightShadow)))
            {
                ...
                SetupMainLightShadowReceiverConstants(cmd, shadowLight, shadowData, shadowData.supportsSoftShadows);
            }
        ...
        void SetupMainLightShadowReceiverConstants(CommandBuffer cmd, VisibleLight shadowLight, ShadowData shadowData,  bool supportsSoftShadows)
        {
            Light light = shadowLight.light;
            ...
            if (supportsSoftShadows)
            {
                ...
                if (shadowData.shadowNoiseTex != null)
                {
                    cmd.SetGlobalTexture(MainLightShadowConstantBuffer._ShadowNoiseTex, shadowData.shadowNoiseTex);
                    cmd.SetGlobalFloat(MainLightShadowConstantBuffer._ShadowNoiseTexResolution, shadowData.shadowNoiseTex.width);
                }

                cmd.SetGlobalFloat(MainLightShadowConstantBuffer._ShadowPCSFilterRadius, shadowData.pcsFilterRadius);
                cmd.SetGlobalFloat(MainLightShadowConstantBuffer._ShadowPCSSSearchRadius, shadowData.pcssSearchRadius);
